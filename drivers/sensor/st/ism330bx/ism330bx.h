...
#ifndef ZEPHYR_DRIVERS_SENSOR_ISM330BX_H_
#define ZEPHYR_DRIVERS_SENSOR_ISM330BX_H_
...
#define ISM330BX_EN_BIT  0x01
#define ISM330BX_DIS_BIT 0x00
...
#define ISM330BX_SHUB_MAX_NUM_TARGETS 3

struct ism330bx_data {
	...
	uint8_t ext_data[ISM330BX_SHUB_MAX_NUM_TARGETS][6];
	uint16_t magn_gain;
	...
	K_KERNEL_STACK_MEMBER(thread_stack, CONFIG_ISM330BX_THREAD_STACK_SIZE);
...
#endif /* ZEPHYR_DRIVERS_SENSOR_ISM330BX_H_ */
